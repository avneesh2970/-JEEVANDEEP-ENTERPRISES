...
export const CORE_VALUES: CoreValue[] = [
  {
    ...
    title: 'Integrity',
    icon: 'handshake',
    description: 'Building long-term trust through transparent and ethical business practices.',
  },
  {
    id: 'quality',
    title: 'Quality',
    icon: 'high_quality',
    description: 'Sourcing and delivering only certified, high-performance industrial materials.',
  },
  {
    id: 'reliability',
    title: 'Reliability',
    icon: 'schedule',
    description: 'Unwavering commitment to on-time delivery for mission-critical projects.',
  },
  {
    id: 'expertise',
    title: 'Expertise',
    icon: 'engineering',
    description: 'Providing deep technical support to ensure clients select the optimal materials.',
  },
];
...
export const PRODUCT_CATEGORIES: ProductCategory[] = [
  {
    ...
    name: 'Insulation',
    icon: 'architecture',
    description: 'High-performance thermal, acoustic, and refractory insulation materials for industrial HVAC, power plants, and building infrastructure.',
    itemCount: 28,
    highlightSpecs: ['Thermal Conductivity ≤ 0.033 W/m·K', 'Class 0 / Class 1 Fire Rating', 'Temp Range: -200°C to +1425°C'],
    subcategories: ['Rockwool Slabs & Pipe Sections', 'Glass Wool Acoustic Rolls', 'Accosound Damping Sheets', 'XLPE Foam Sheets', 'Air Bubble Foil Sheets', 'Tissue Paper & Glass Cloth'],
    products: [
      {
        id: 'prod-01',
      ...
      },
      {
        ...
        description: 'High reflectance thermal radiant barrier double-sided aluminum foil laminated polyethylene air bubble sheet for metal roof sheds, poultry farms, and HVAC duct wrapping.',
  ...
  },
  {
    ...
    name: 'Rubber',
    icon: 'category',
    description: 'Durable industrial elastomeric rubber products including electrical insulation mats, Nitrile NBR sheets, EPDM steam sheets, and Silicone rubber.',
    itemCount: 34,
    highlightSpecs: ['Electrical Safety up to 33kV (IS 15652 / IEC 61111)', 'Oil & Chemical Resistant NBR Grades', 'Food Grade Silicone & EPDM Steam Sheets'],
    subcategories: ['Nitrile Rubber Sheets & Tubes', 'High Voltage Dielectric Safety Mats', 'Silicon Rubber Sheets & Tubes', 'EPDM Weather Strips', 'Neoprene Flange Gaskets'],
    products: [
      {
        id: 'prod-03',
  ...
  },
  {
    ...
    description: 'Heavy duty electrical cable trays, GI raceways, explosion-proof double compression cable glands, and wiring management systems.',
    itemCount: 42,
    highlightSpecs: ['GI Perforated & Ladder Cable Trays', 'Flameproof Double Compression Cable Glands (Ex-d)', 'IP66/IP68 Weatherproof Accessories'],
    subcategories: ['GI Perforated & Ladder Cable Trays', 'Ex-d Flameproof Cable Glands', 'Unistrut Channel Cable Mounts', 'Brass & Nickel-Plated Glands'],
    products: [
      {
        id: 'prod-07',
  ...
  },
  {
    ...
    name: 'Hardware',
    icon: 'build',
    description: 'High tensile fasteners, Grade 8.8/10.9/B7 stud bolts, GI sheets, C channels, tie rods, and structural mechanical supports.',
    itemCount: 50,
    highlightSpecs: ['High Tensile 8.8 / 10.9 / 12.9 Fasteners', 'ASTM A193 Grade B7 High-Temp Stud Bolts', 'GI Sheets & Slotted C Channels'],
    subcategories: ['Slotted C Channels & Strut Arms', 'Nut Bolts & Washer Sets', 'Formwork Threaded Tie Rods', 'Galvanized Iron GI Sheets', 'ASTM A193 B7 Stud Bolts'],
    products: [
      {
        id: 'prod-06',
  ...
  },
  {
    ...
    icon: 'verified_user',
    description: 'Specialized industrial adhesives, synthetic rubber bonding agents, self-adhesive foam tapes, and non-asbestos flange gaskets.',
    itemCount: 22,
    highlightSpecs: ['SR 505 Synthetic Rubber Adhesive', 'Star Bond Duct Sealant', 'Self-Adhesive Foam Tapes & ASME Gaskets'],
    subcategories: ['SR 505 Contact Adhesive', 'Star Bond Duct Sealant', 'Self-Adhesive Foam Tape & Gaskets', 'Spiral Wound Metallic Gaskets'],
    products: [
      {
        id: 'prod-09',
        name: 'Tape and Gasket (Self-Adhesive Foam & Flange Seals)',
        category: 'Sealing & Adhesives',
