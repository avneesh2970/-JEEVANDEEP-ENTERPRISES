      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10 px-4 sm:px-6 md:px-12 py-16 max-w-[1280px] mx-auto text-left">
        ...
        <div className="md:col-span-4 space-y-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-['Manrope'] text-lg font-extrabold text-white tracking-tight">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-xs text-[#fea619] font-['Inter'] font-semibold">
            <ShieldCheck className="w-4 h-4 text-[#fea619]" />
            <span>ISO 9001:2015 Certified Operations</span>
          </div>

          <p className="font-['Inter'] text-xs text-slate-500 pt-2">
        ...
        <div className="md:col-span-2 space-y-4">
          <h4 className="font-['Inter'] text-xs font-bold text-[#fea619] uppercase tracking-wider">
            Product Lines
          </h4>
        ...
        <div className="md:col-span-4 space-y-4">
          ...
          <form onSubmit={handleSubscribe} className="flex items-center gap-2">
            <input
              ...
              className="bg-white/10 border border-white/15 focus:border-[#fea619] rounded-lg px-3.5 py-2 text-xs font-['Inter'] text-white placeholder-slate-400 outline-hidden grow"
            />
            <button
              type="submit"
              className="bg-[#fea619] hover:bg-[#e69310] text-[#002147] font-['Inter'] text-xs font-bold px-4 py-2 rounded-lg transition-colors cursor-pointer shrink-0"
            >
          ...
          <div className="pt-2 flex items-center justify-between">
            <span className="text-xs text-slate-400 font-mono">Mumbai, India</span>
            <button
              onClick={scrollToTop}
