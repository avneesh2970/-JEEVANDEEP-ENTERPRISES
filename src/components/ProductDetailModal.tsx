      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/75 backdrop-blur-sm">
        ...
        >
          ...
          <div className="p-6 overflow-y-auto space-y-8 grow">
            ...
            <div>
              <h4 className="font-['Manrope'] text-xs font-bold uppercase tracking-wider text-[#002147] mb-3 flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2.5">
                {category.subcategories.map((sub, i) => (
                  <div
                    key={i}
                    className="bg-[#f2f4f6] text-xs font-['Inter'] font-semibold text-[#191c1e] px-3.5 py-2.5 rounded-lg border border-[#e0e3e5] flex items-center gap-2"
                  >
            ...
            <div className="flex items-center justify-between gap-4 pt-2 border-t border-[#e0e3e5]">
              <h4 className="font-['Manrope'] text-base font-bold text-[#002147]">
              ...
              <div className="relative w-64">
                ...
                <input
                  ...
                  className="w-full bg-[#f7f9fb] border border-[#c4c6cf] focus:border-[#002147] rounded-lg pl-8 pr-3 py-1.5 text-xs font-['Inter'] text-[#191c1e] outline-hidden"
                />
              </div>
            </div>
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#e0e3e5] pb-3 mb-3">
                    <div>
                      ...
                      <span className="font-['Manrope'] text-base font-bold text-[#000a1e]">
                        {item.name}
                      </span>
                    </div>
                    <span className="text-xs font-['Inter'] text-emerald-800 bg-emerald-50 border border-emerald-300 px-3 py-0.5 rounded-full self-start sm:self-auto font-bold">
                      ● In Stock & Ready for Dispatch
                    </span>
                  </div>

                  <p className="font-['Inter'] text-xs sm:text-sm text-[#44474e] mb-3 leading-relaxed">
                    {item.description}
                  </p>
                  ...
                  {/* Specs Grid */}
                  <div className="bg-[#f7f9fb] p-3.5 rounded-lg border border-[#e0e3e5] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 text-xs font-['Inter'] mb-4">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
                    ...
                    <button
                      ...
                      className="bg-[#fea619] hover:bg-[#e69310] text-[#002147] text-xs font-['Inter'] font-extrabold px-5 py-2.5 rounded-lg shadow-2xs flex items-center gap-1.5 cursor-pointer uppercase tracking-wider transition-colors"
                    >
          ...
          <div className="bg-[#f2f4f6] px-6 py-4 border-t border-[#c4c6cf] flex items-center justify-between shrink-0">
            ...
            <button
              onClick={onClose}
              className="bg-[#002147] text-white text-xs font-['Inter'] font-bold px-5 py-2.5 rounded-lg hover:bg-[#000a1e] transition-colors cursor-pointer"
            >
              Close Catalog
            </button>
          </div>
